...
from mcp.prompts.base import SystemMessage, UserMessage, AssistantMessage
...
@mcp.prompt()
def analyze_pmd_violations(pmd_output: str) -> list[Message]:
    return [
        SystemMessage("""You are a senior software engineer performing code quality review.
Your task is to analyze PMD static code analysis results and provide actionable insights.
Focus on concrete examples and specific file locations when discussing issues."""),
        
        UserMessage("""Please analyze these PMD violations and provide:
1. Overall assessment of code quality
2. Most critical issues requiring immediate attention
3. Specific code snippets and file locations for each issue
4. Concrete recommendations for fixing each issue
5. Prioritized action items"""),
        
        UserMessage(pmd_output),
        
        AssistantMessage("""I'll help analyze these PMD results. First, let me check the specific files and their violations,
then provide a detailed analysis with concrete examples and fixes.""")
    ]
